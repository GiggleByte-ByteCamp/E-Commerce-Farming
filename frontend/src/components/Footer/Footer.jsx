    ...
    <BrowserRouter>
      ...
      >
        ...
        <MDBContainer className="mt-5 mb-4 text-center text-md-left">
          <MDBRow className="mt-3">
            <MDBCol md="3" lg="3    " xl="3" className="mb-4 dark-grey-text">
              ...
              />
              <p>
                The purpose of Agventure is to provide connections between
            ...
            <MDBCol md="3" lg="3" xl="4" className="mb-4 dark-grey-text">
              ...
              />
              <p>
                <i className="fa fa-home mr-3" /> Mumbai, India
              </p>
              <p>
        ...
        <div className="footer-copyright text-center py-3">
          <MDBContainer fluid>
            &copy; {new Date().getFullYear()} Copyright: Agventure
          </MDBContainer>
        </div>
      </MDBFooter>
    </BrowserRouter>
